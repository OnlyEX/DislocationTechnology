...
//    public static IsaMillRenderer ISA_MILL = new IsaMillRenderer();
    ...
    public static void register(TextureMap textureMap) {
        ...
        HALO = textureMap.registerSprite(DTUtils.naxId("items/halo"));
        HALO_NOISE = textureMap.registerSprite(DTUtils.naxId("items/halo_noise"));

        SUPRA_DIMENSION_RESEARCH_DATA_CARD_HALO = textureMap.registerSprite(DTUtils.naxId("items/supra_dimension_research_data_card_halo"));

        MASK_INGOT = textureMap.registerSprite(DTUtils.naxId( "items/mask_ingot"));

        ETERNAL_SINGULARITY = textureMap.registerSprite(DTUtils.naxId( "items/eternal_singularity_mask"));
        COMBINED_SINGULARITY = textureMap.registerSprite(DTUtils.naxId( "items/combined_singularity_mask"));

        COSMIC_0 = textureMap.registerSprite(DTUtils.naxId("shader/cosmic_0"));
        COSMIC_1 = textureMap.registerSprite(DTUtils.naxId("shader/cosmic_1"));
        COSMIC_2 = textureMap.registerSprite(DTUtils.naxId("shader/cosmic_2"));
        COSMIC_3 = textureMap.registerSprite(DTUtils.naxId("shader/cosmic_3"));
        COSMIC_4 = textureMap.registerSprite(DTUtils.naxId("shader/cosmic_4"));
        COSMIC_5 = textureMap.registerSprite(DTUtils.naxId("shader/cosmic_5"));
        COSMIC_6 = textureMap.registerSprite(DTUtils.naxId("shader/cosmic_6"));
        COSMIC_7 = textureMap.registerSprite(DTUtils.naxId("shader/cosmic_7"));
        COSMIC_8 = textureMap.registerSprite(DTUtils.naxId("shader/cosmic_8"));
        COSMIC_9 = textureMap.registerSprite(DTUtils.naxId("shader/cosmic_9"));

        FORCE_FIELD = textureMap.registerSprite(DTUtils.naxId("blocks/force_field"));
        ...
        //TODO 材质
        RESEARCH_PIPE_IN = textureMap.registerSprite(DTUtils.naxId("blocks/pipe/pipe_research_in"));
        RESEARCH_PIPE_SIDE = textureMap.registerSprite(DTUtils.naxId("blocks/pipe/pipe_research_side"));
        RESEARCH_PIPE_SIDE_OVERLAY = textureMap.registerSprite(DTUtils.naxId("blocks/pipe/pipe_research_side_overlay"));
        RESEARCH_PIPE_SIDE_OVERLAY_ACTIVE = textureMap.registerSprite(DTUtils.naxId("blocks/pipe/pipe_research_side_overlay_active"));
    }
