package onlyex.dislocationtechnology.client.utils;

import onlyex.dislocationtechnology.api.utils.DTLog;
import onlyex.dislocationtechnology.client.shader.ShaderCallback;
...
public final class ShaderHelper {
    ...
    private static final String PREFIX = "/assets/dislocationtechnology/shader/";
    ...
    private static int createProgram(String vert, String frag) {
        ...
        if (ARBShaderObjects.glGetObjectParameteriARB(program, ARBShaderObjects.GL_OBJECT_LINK_STATUS_ARB) == GL11.GL_FALSE) {
            DTLog.logger.log(Level.ERROR, getLogInfo(program));
            return 0;
        }
