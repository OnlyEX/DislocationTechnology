...
import onlyex.dislocationtechnology.common.items.behaviors.renderer.CosmicRenderItemBehavior;
...
//        GRINDBALL_SOAPSTONE = this.addItem(41, "mill.grindball_soapstone")
//                .setMaxStackSize(1).addComponents(new MillBallBehavior());
//        GRINDBALL_ALUMINIUM = this.addItem(42, "mill.grindball_aluminium")
//                .setMaxStackSize(1).addComponents(new MillBallBehavior());

        NULL = this.addItem(43, "null")
                .addComponents(new CosmicRenderItemBehavior(() -> DTTextures.MASK_INGOT, 1));
        PINE_CONE = this.addItem(44, "item.pine_cone");
        PINE_FRAGMENT = this.addItem(45, "item.pine_fragment");
//        BIOLOGY_INTEGRATED_CIRCUIT = this.addItem(46, "item.biology_integrated_circuit")
//                .addComponents(new IntBcircuitBehavior());
        CHROMATIC_LENS = this.addItem(47, "chromatic_lens")
                .addOreDict("craftingLensChromatic");
        QCD_PROTECTIVE_PLATING = this.addItem(48, "qcd_protective_plating");

        CRYSTAL_ADVANCED_RAW_CHIP = this.addItem(49, "crystal.advanced_raw_chip");
        ...
        //240~256 singularity  //.addComponents(new HaloRenderItemBehavior(10, 0xFF000000, () -> DTTextures.HALO, false))
        ETERNAL_SINGULARITY = this.addItem(240, "singularity.eternal_singularity")
                .addComponents(new CosmicRenderItemBehavior(() -> DTTextures.ETERNAL_SINGULARITY, 1));
        GASTRONOMIC_SINGULARITY = this.addItem(241, "singularity.gastronomic_singularity")
                .addComponents(new CosmicRenderItemBehavior(() -> DTTextures.COMBINED_SINGULARITY, 1));
        ...
        SUPRA_DIMENSION_RESEARCH_DATA_CARD = this.addItem(2407,"supra_dimension_research_data_card")
                .addComponents(new DataItemResearch(), new CosmicRenderItemBehavior(() -> DTTextures.SUPRA_DIMENSION_RESEARCH_DATA_CARD_HALO, 1));
*/
