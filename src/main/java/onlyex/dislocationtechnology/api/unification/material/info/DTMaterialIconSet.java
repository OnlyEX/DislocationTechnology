...
import onlyex.dislocationtechnology.common.items.behaviors.renderer.DataRenderItemBehavior;
...
//TODO @ZenClass("mods.dislocationtechnology.material.MaterialIconSet")
@ZenRegister
public class DTMaterialIconSet {
    ...
    public static final MaterialIconSetWithRenderer CUSTOM_ETERNITY = new MaterialIconSetWithRenderer("eternity", null, true, new HaloRenderItemBehavior(10, 0xFF000000, () -> DTTextures.HALO, true));
    public static final MaterialIconSetWithRenderer CUSTOM_INFINITY = new MaterialIconSetWithRenderer("infinity", null, true, new HaloRenderItemBehavior(10, 0xFF000000, () -> DTTextures.HALO, true));

    public static final MaterialIconSetWithRenderer CUSTOM_UNIVERSIUM = new MaterialIconSetWithRenderer("universium", null, true,  new CosmicRenderItemBehavior(() -> DTTextures.HALO, 1));
